  ...
  return (
    <div className=" flex flex-wrap bg-Cardoverl">
      <div className=" flex flex-col bg-white rounded-lg shadow-md w-full m-6 overflow-hidden text-yellow-400 sm:w-500">
        30% off
        <img
          src="https://demo.bestrolly.com/_next/image?url=https%3A%2F%2Fimages.nana.sa%2Fpics%2F03e6b2876d95a93407750d2ade8cbaebc7bef49a-00%3D%3Dh400%3Dw400.jpg&w=128&q=75 "
          alt=""
          className=" h-20 m-6"
        />
        <div>
          <h2 className=" text-center px-2 pb-5 text-black"> SAR 7.4 </h2>
          <h2 className=" text-center px-2 pb-5 text-black">
            
          Halwani and Tahhan Chickpeas 500 G
          </h2>
